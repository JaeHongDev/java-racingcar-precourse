...
- 심판 도메인
  - [X] 심판은 플레이어에게 참여할 자동차 목록을 만들도록 요청하여 해당 목록을 응답 받습니다.
  - [X] 심판은 플레이어에게 게임을 몇번 진행할 것인지 요청하여 결과값을 응답 받습니다.
  - [X] 심판은 플레이어에게 받아온 정보를 토대로 게임을 진행 시킵니다.
  - [X] 게임을 진행 시키면서 결과 값을 게임 프린터에게 출력을 요청하며 응답은 받지 않습니다. (ONLY 출력)
  - [X] 자동차 명단을 확인 한 후 게임 우승자를 판단 하고 게임 프린터에 결과를 요청합니다 (ONLY 출력)[요구사항 #6]
  - [X] 우승자가 여러명인 경우 쉼표를 기준으로 구분하여 게임 프린터에 결과를 요청함(ONLY 출력)[요구사항 #7]
- 플레이어 도메인
  - [X] 게임에 참여할 자동차를 생성합니다.
  - [X] 게임을 몇 번 진행할 것인지 정합니다. [요구사항 #4]
  - [X] 게임에 참여하는 자동차의 이름이 5자가 넘지 않도록 확인합니다. [요구사항 #3]
