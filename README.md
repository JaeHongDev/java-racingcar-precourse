...
- 자동차 도메인
  - [ ] 자동차는 생성자를 통해서 자동차의 이름을 주입받습니다.[요구사항 #2]
  - [ ] 자동차는 자신 스스로 출력에 대한 정보를 제공합니다. [요구사항 #2]
  - [ ] 자동차는 랜덤한 값(0 ~ 9 사이에서 4 이상의 경우 전진)에 따라 한 칸 이동 하거나 멈춥니다 [요구사항 #5,#1]
- 프린터 도메인
  - [ ] 게임 출력에 필요한 상수값 정의 및 출력 메서드 생성
    - [ ] 에러 메시지 
    - [ ] 실행 결과 
    - [ ] 시작 메시지 
    - [ ] 게임 진행 수 요청 메시지 
